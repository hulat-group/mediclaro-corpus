"""
Inference script: Text simplification using the base model BSC-LT/salamandra-7b-instruct (Causal LM) with prompt engineering and CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto3_prompt/simplificaciones/salamandra_7B_instruct"    
