"""
Inference script: Text simplification using fine-tuned BSC-LT/salamandra-7b-instruct (Causal LM) with LoRA adapters (PEFT).
...
output_folder = "../../Conjunto1_finetunning/simplificaciones/salamandra_7B_instruct"     
