"""
Inference script: Simplification with fine-tuned Llama-3.2-3B-Instruct (LoRA adapter) + CodeCarbon (offline).
...
output_folder = "../../Conjunto1_finetunning/simplificaciones/llama3_2_3B_instruct"    
