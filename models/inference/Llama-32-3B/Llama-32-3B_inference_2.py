"""
Inference script: Text simplification using fine-tuned Llama-3.2-3B-Instruct (LoRA) with custom prompt and CodeCarbon tracking (offline).

This script performs generation using:
...
output_folder = "../../Conjunto2_fprompt/simplificaciones_f_prompt/llama3_2_3B_instruct"     
