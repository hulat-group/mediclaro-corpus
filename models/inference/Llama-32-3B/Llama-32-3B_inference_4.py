"""
Inference script: Text simplification using a fine-tuned Llama-3.2-3B-Instruct model (LoRA adapter) with prompt engineering and CodeCarbon tracking (offline).

This script generates simplifications of Spanish clinical texts using:
- Base model: meta-llama/Llama-3.2-3B-Instruct
- Fine-tuned LoRA adapter loaded via PEFT from a local directory.
- A reinforced domain-specific prompt aligned with UNE-ISO 24495-1 guidelines.
...
output_folder = "../../Conjunto4_reforzado/simplificaciones/llama3_2_3B_instruct"    
...
try:
    ...
    adapter_dir = "../../finetuning/FineTuningLlama-3.2-3B-Instruct"  
    ...
    for filename in files:
        ...
        # 🔹 Mostrar número de tokens del texto actual
        print(f"📄 {filename} → {len(inputs['input_ids'][0])} tokens")
