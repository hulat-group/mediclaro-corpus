"""
Inference script: Text simplification using fine-tuned HiTZ/Medical-mT5-xl (Seq2Seq) with LoRA adapters (PEFT) with custom prompt and CodeCarbon tracking (offline).

This script performs generation with:
- Base model: HiTZ/Medical-mT5-xl
- LoRA adapter loaded from a local fine-tuning directory.
...
Outputs:
- Simplified .txt files stored in the specified output directory.
...
output_folder = "../../Conjunto2_fprompt/simplificaciones_f_prompt/medical_mt5_xl"    
...
try:
    ...
    adapter_dir = "../../finetuning/FineTuningMT5_XL" 
