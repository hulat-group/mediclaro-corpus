"""
Inference script: Text simplification using a fine-tuned using fine-tuned HiTZ/Medical-mT5-xl (Seq2Seq) with LoRA adapters and prompt reinforced, including CodeCarbon tracking (offline).

This script generates adaptations of Spanish clinical texts using:
- Base model: HiTZ/Medical-mT5-xl.
- LoRA adapter previously fine-tuned and loaded via PEFT.
...
output_folder = "../../Conjunto4_reforzado/simplificaciones/medical_mt5_xl"     
