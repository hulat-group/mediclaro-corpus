"""
Inference script: Text simplification using fine-tuned HiTZ/Medical-mT5-xl (Seq2Seq)  with LoRA adapters (PEFT).
...
output_folder = "../../Conjunto1_finetunning/simplificaciones/medical_mt5_xl"    
...
for filename in files:
    ...
    # Formateo del prompt
    prompt = "TEXTO A SIMPLIFICAR: " + text
