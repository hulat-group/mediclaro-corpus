"""
Inference script: Text simplification using the base model IIC/RigoChat-7b-v2 (Causal LM) with prompt engineering and CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto3_prompt/simplificaciones/rigochat_7B"    
