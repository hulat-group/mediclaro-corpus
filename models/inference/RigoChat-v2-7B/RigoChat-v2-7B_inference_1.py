"""
Inference script: Text simplification using fine-tuned IIC/RigoChat-7b-v2 (Causal LM) with LoRA adapters (PEFT).
...
output_folder = "../../Conjunto1_finetunning/simplificaciones/rigochat_7B"    
