"""
Inference script: Text simplification using a fine-tuned Llama-3.2-1B-Instruct model (LoRA adapter) with prompt engineering and CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto4_reforzado/simplificaciones/llama3_2_1B_instruct"    
os.makedirs(output_folder, exist_ok=True)

# ===================================
# ORDENAR ARCHIVOS POR NÚMERO DE CASO
# ===================================
