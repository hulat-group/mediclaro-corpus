"""
Inference script: Text simplification using the base model meta-llama/Llama-3.2-1B-Instruct with prompt engineering and CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto3_prompt/simplificaciones/llama3_2_1B_instruct"     
