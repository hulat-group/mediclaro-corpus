"""
Inference script: Text simplification using fine-tuned Llama-3.2-1B-Instruct (LoRA) with custom prompt and CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto2_fprompt/simplificaciones/llama3_2_1B_instruct"      
