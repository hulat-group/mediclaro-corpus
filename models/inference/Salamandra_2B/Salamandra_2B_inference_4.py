"""
Inference script: Text simplification using using fine-tuned BSC-LT/salamandra-2b-instruct (Causal LM) with LoRA adapters and reinforced prompt, including CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto4_reforzado/simplificaciones/salamandra_2B_instruct"    
