"""
Inference script: Text simplification using fine-tuned BSC-LT/salamandra-2b-instruct (Causal LM) with LoRA adapters (PEFT), with prompt engineering and CodeCarbon tracking (offline).
...
output_folder = "../../Conjunto2_fprompt/simplificaciones/salamandra_2B_instruct"    
