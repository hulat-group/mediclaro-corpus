"""
Fine-tuning script: BSC-LT/salamandra-7b-instruct (Causal LM) using SFT + LoRA with 4-bit QLoRA and CodeCarbon (offline).
...
# ---- FORMATEO TIPO INSTRUCTION PARA (Salamandra) ----
...
training_args = TrainingArguments(
    output_dir="../../finetuning/FineTuningSalamandra-7B-Instruct",
...
trainer.train()
trainer.save_model()
tokenizer.save_pretrained("../../finetuning/FineTuningSalamandra-7B-Instruct/tokenizer")
