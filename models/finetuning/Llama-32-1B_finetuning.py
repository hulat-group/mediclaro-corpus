"""
Fine-tuning script: Llama-3.2-1B-Instruct (Causal LM) using SFT + LoRA with 4-bit QLoRA and CodeCarbon (offline).
...
training_args = TrainingArguments(
    output_dir="../../finetuning/FineTuningLlama-3.2-1B-Instruct",
...
trainer.train()
trainer.save_model()
tokenizer.save_pretrained("../../finetuning/FineTuningLlama-3.2-1B-Instruct/tokenizer")
